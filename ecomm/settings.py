...
SECRET_KEY = 'django-insecure-+0sh+8*n@(r16i(ge-u=4_tr6o=7+p(pg-&qf+sl$p)4r&sdf&'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static/app'),  # For your custom static files during development
]
